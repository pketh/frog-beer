...
(function() {
  var activePalette, drawPixelsOnCanvas, getPixels, highlightActivePaletteColor, newPalette, paintCanvasRow, pixels, pressingDown, selectColor, updatePalette;
  ...
  $('.save-button').click(function() {
    getPixels();
    return drawPixelsOnCanvas(pixels);
  });
