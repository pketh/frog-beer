...
(function() {
  var activePalette, drawPixelsOnCanvas, getPixels, highlightActivePaletteColor, newPalette, paintCanvasRow, pixels, pressingDown, saveCanvas, selectColor, updatePalette;
  ...
  paintCanvasRow = function(pixelColor, index, row) {
    var PIXEL_SIZE, X, Y, canvas, context;
    PIXEL_SIZE = 20;
    X = 20 * index - (400 * row);
    Y = 20 * row;
  ...
  saveCanvas = function() {
    ...
    return console.log("use AJAX to POST the img variable to the server");
  };
