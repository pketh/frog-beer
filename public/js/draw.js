...
(function() {
  var CANVAS_SIZE, PIXEL_SIZE, activePalette, clearCanvas, currentPalette, drawPixelsOnCanvas, getPixels, highlightActivePaletteColor, newPalette, paintCanvasRow, pixels, pressingDown, saveCanvas, selectColor, updatePalette;
  ...
  newPalette = function() {
    ...
    updatePalette();
    return currentPalette = currentPalette + 1;
  };
